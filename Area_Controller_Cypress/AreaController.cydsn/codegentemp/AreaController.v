// ======================================================================
// AreaController.v generated from TopDesign.cysch
// 11/05/2018 at 00:56
...
`ifdef WARP
`define CY_BLK_DIR "C:\Program Files (x86)\Cypress\PSoC Creator\4.2\PSoC Creator\psoc\content\CyPrimitives\cyprimitives.cylib\cy_dffe_v1_0"
`include "C:\Program Files (x86)\Cypress\PSoC Creator\4.2\PSoC Creator\psoc\content\CyPrimitives\cyprimitives.cylib\cy_dffe_v1_0\cy_dffe_v1_0.v"
`else
`define CY_BLK_DIR "C:\Program Files (x86)\Cypress\PSoC Creator\4.2\PSoC Creator\psoc\content\CyPrimitives\cyprimitives.cylib\cy_dffe_v1_0"
`include "C:\Program Files (x86)\Cypress\PSoC Creator\4.2\PSoC Creator\psoc\content\CyPrimitives\cyprimitives.cylib\cy_dffe_v1_0\cy_dffe_v1_0.v"
`endif
...
module ADC_DelSig_v3_30_1 (
	...
	cy_clock_v1_0
		#(.id("680ca672-8fcd-47cb-abfe-d0ca4037a9aa/b7604721-db56-4477-98c2-8fae77869066"),
	...
	cy_clock_v1_0
		#(.id("680ca672-8fcd-47cb-abfe-d0ca4037a9aa/edd15f43-b66b-457b-be3a-5342345270c8"),
		  .source_clock_id("61737EF6-3B74-48f9-8B91-F7473A442AE7"),
		  .divisor(0),
		  .period("7812500000"),
		  .is_direct(0),
...
module top ;
    ...
    assign Net_102 = ~Net_136;


    assign Net_37 = Net_142 ^ Net_117;


    assign Net_122 = Net_117 ^ Net_136;

    // -- DFFE Start --
    reg  cy_dffe_2;
    always @(posedge Net_123)
    begin
        cy_dffe_2 <= Net_135 ? Net_37 : cy_dffe_2;
    end
    assign Net_136 = cy_dffe_2;
    // -- DFFE End --
    ...
    always @(posedge Net_123)
    begin
        cy_dffe_1 <= Net_135 ? Net_122 : cy_dffe_1;
    end
    assign Net_118 = cy_dffe_1;
    // -- DFFE End --

	wire [3:0] tmpOE__STEP_OUT_net;
	wire [3:0] tmpFB_3__STEP_OUT_net;
	wire [3:0] tmpIO_3__STEP_OUT_net;
	wire [0:0] tmpINTERRUPT_0__STEP_OUT_net;
	electrical [0:0] tmpSIOVREF__STEP_OUT_net;
	...
	cy_psoc3_pins_v1_10
		...
		STEP_OUT
		 (.oe(tmpOE__STEP_OUT_net),
		  .y({Net_102, Net_136, Net_142, Net_118}),
		  .fb({tmpFB_3__STEP_OUT_net[3:0]}),
		  .io({tmpIO_3__STEP_OUT_net[3:0]}),
		  .siovref(tmpSIOVREF__STEP_OUT_net),
		  .interrupt({tmpINTERRUPT_0__STEP_OUT_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__STEP_OUT_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{Net_135, Net_135, Net_135, Net_135} : {Net_135, Net_135, Net_135, Net_135};

    CyControlReg_v1_80 Step_Control (
        .control_1(Net_123),
        .control_2(Net_117),
        .control_3(Net_146),
        .control_0(Net_135),
        ...
        .clock(1'b0),
        .reset(1'b0));
    defparam Step_Control.Bit0Mode = 0;
    defparam Step_Control.Bit1Mode = 0;
    defparam Step_Control.Bit2Mode = 0;
    defparam Step_Control.Bit3Mode = 0;
    defparam Step_Control.Bit4Mode = 0;
    defparam Step_Control.Bit5Mode = 0;
    defparam Step_Control.Bit6Mode = 0;
    defparam Step_Control.Bit7Mode = 0;
    defparam Step_Control.BitValue = 0;
    defparam Step_Control.BusDisplay = 0;
    defparam Step_Control.ExtrReset = 0;
    defparam Step_Control.NumOutputs = 3;


    assign Net_142 = ~Net_118;
	...
	wire [3:0] tmpOE__RGB_OUT_net;
	wire [3:0] tmpFB_3__RGB_OUT_net;
	wire [3:0] tmpIO_3__RGB_OUT_net;
	wire [0:0] tmpINTERRUPT_0__RGB_OUT_net;
	electrical [0:0] tmpSIOVREF__RGB_OUT_net;

	cy_psoc3_pins_v1_10
		#(.id("53957ae7-d0a9-49d9-9270-31cfb48e0c8b"),
		  .drive_mode(12'b110_110_110_110),
		  .ibuf_enabled(4'b1_1_1_1),
		  .init_dr_st(4'b0_0_0_0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(8'b00_00_00_00))
		RGB_OUT
		 (.oe(tmpOE__RGB_OUT_net),
		  .y({4'b0}),
		  .fb({tmpFB_3__RGB_OUT_net[3:0]}),
		  .io({tmpIO_3__RGB_OUT_net[3:0]}),
		  .siovref(tmpSIOVREF__RGB_OUT_net),
		  .interrupt({tmpINTERRUPT_0__RGB_OUT_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__RGB_OUT_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{4'b1111} : {4'b1111};
	...
	wire [0:0] tmpOE__LIGHT_SENS_IN_net;
	wire [0:0] tmpFB_0__LIGHT_SENS_IN_net;
	wire [0:0] tmpIO_0__LIGHT_SENS_IN_net;
	wire [0:0] tmpINTERRUPT_0__LIGHT_SENS_IN_net;
	electrical [0:0] tmpSIOVREF__LIGHT_SENS_IN_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("77715107-f8d5-47e5-a629-0fb83101ac6b"),
		  ...
		  .input_buffer_sel(2'b00))
		LIGHT_SENS_IN
		 (.oe(tmpOE__LIGHT_SENS_IN_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__LIGHT_SENS_IN_net[0:0]}),
		  .analog({Net_180}),
		  .io({tmpIO_0__LIGHT_SENS_IN_net[0:0]}),
		  .siovref(tmpSIOVREF__LIGHT_SENS_IN_net),
		  .interrupt({tmpINTERRUPT_0__LIGHT_SENS_IN_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__LIGHT_SENS_IN_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

    // -- AMux A_SENS start -- ***
    // -- Mux A --
    
    cy_psoc3_amux_v1_0 A_SENS(
        .muxin({
            Net_182,
            Net_181,
            Net_180
    ...
    defparam A_SENS.muxin_width = 3;
    defparam A_SENS.init_mux_sel = 3'h0;
    defparam A_SENS.one_active = 0;
    defparam A_SENS.connect_mode = 2;
    
    // -- AMux A_SENS end --

	wire [0:0] tmpOE__DIS_SENS_IN_net;
	wire [0:0] tmpFB_0__DIS_SENS_IN_net;
	wire [0:0] tmpIO_0__DIS_SENS_IN_net;
	wire [0:0] tmpINTERRUPT_0__DIS_SENS_IN_net;
	electrical [0:0] tmpSIOVREF__DIS_SENS_IN_net;

	cy_psoc3_pins_v1_10
		#(.id("1d5696ad-8280-4540-9d8c-ce0ceadbc3a8"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		DIS_SENS_IN
		 (.oe(tmpOE__DIS_SENS_IN_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__DIS_SENS_IN_net[0:0]}),
		  .analog({Net_181}),
		  .io({tmpIO_0__DIS_SENS_IN_net[0:0]}),
		  .siovref(tmpSIOVREF__DIS_SENS_IN_net),
		  .interrupt({tmpINTERRUPT_0__DIS_SENS_IN_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__DIS_SENS_IN_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__TMP36_SENS_IN_net;
	wire [0:0] tmpFB_0__TMP36_SENS_IN_net;
	wire [0:0] tmpIO_0__TMP36_SENS_IN_net;
	wire [0:0] tmpINTERRUPT_0__TMP36_SENS_IN_net;
	electrical [0:0] tmpSIOVREF__TMP36_SENS_IN_net;

	cy_psoc3_pins_v1_10
		#(.id("6fcdd8c1-9736-456a-9538-7fecd7df9148"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		TMP36_SENS_IN
		 (.oe(tmpOE__TMP36_SENS_IN_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__TMP36_SENS_IN_net[0:0]}),
		  .analog({Net_182}),
		  .io({tmpIO_0__TMP36_SENS_IN_net[0:0]}),
		  .siovref(tmpSIOVREF__TMP36_SENS_IN_net),
		  .interrupt({tmpINTERRUPT_0__TMP36_SENS_IN_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__TMP36_SENS_IN_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

    CyControlReg_v1_80 TRIG (
        .control_1(Net_452),
        .control_2(Net_453),
        .control_3(Net_454),
        .control_0(Net_470),
        ...
        .clock(1'b0),
        .reset(1'b0));
    defparam TRIG.Bit0Mode = 0;
    defparam TRIG.Bit1Mode = 0;
    defparam TRIG.Bit2Mode = 0;
    defparam TRIG.Bit3Mode = 0;
    defparam TRIG.Bit4Mode = 0;
    defparam TRIG.Bit5Mode = 0;
    defparam TRIG.Bit6Mode = 0;
    defparam TRIG.Bit7Mode = 0;
    defparam TRIG.BitValue = 0;
    defparam TRIG.BusDisplay = 0;
    defparam TRIG.ExtrReset = 0;
    defparam TRIG.NumOutputs = 1;

	wire [0:0] tmpOE__TRG_PIN_net;
	wire [0:0] tmpFB_0__TRG_PIN_net;
	wire [0:0] tmpIO_0__TRG_PIN_net;
	wire [0:0] tmpINTERRUPT_0__TRG_PIN_net;
	electrical [0:0] tmpSIOVREF__TRG_PIN_net;

	cy_psoc3_pins_v1_10
		#(.id("fc64438d-71e4-4ccc-8b78-d9e5f0370c40"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		TRG_PIN
		 (.oe(tmpOE__TRG_PIN_net),
		  .y({Net_470}),
		  .fb({tmpFB_0__TRG_PIN_net[0:0]}),
		  .io({tmpIO_0__TRG_PIN_net[0:0]}),
		  .siovref(tmpSIOVREF__TRG_PIN_net),
		  .interrupt({tmpINTERRUPT_0__TRG_PIN_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__TRG_PIN_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

    Timer_v2_80_2 HCSR04 (
        .reset(Net_470),
        .interrupt(Net_483),
        .enable(Net_469),
        .trigger(1'b1),
        ...
        .tc(Net_488),
        .clock(Net_10));
    defparam HCSR04.CaptureCount = 2;
    defparam HCSR04.CaptureCounterEnabled = 0;
    defparam HCSR04.DeviceFamily = "PSoC5";
    defparam HCSR04.InterruptOnCapture = 0;
    defparam HCSR04.InterruptOnTC = 0;
    defparam HCSR04.Resolution = 16;
    defparam HCSR04.SiliconRevision = "0";
